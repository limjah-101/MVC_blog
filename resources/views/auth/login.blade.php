...
<head>
    ...
    <meta name="description" content="MVC BLOG application">
...
</head><link href="{{ asset('admin/css/app.css') }}" rel="stylesheet">
<body class="bg-dark">
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a href="index.html">
                        <img class="align-content" src="admin/img/logo.png" alt="logo">
                    </a>
                </div>
